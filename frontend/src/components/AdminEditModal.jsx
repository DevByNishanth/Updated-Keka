...
const AdminEditModal = ({
  ...
  return (
    <>
      ...
      {changeStatusModal ? (
        <div className="changeStatusModal h-[300px]   fixed top-[20%] left-[50%] translate-x-[-50%] rounded-lg z-[100] w-[80%] sm:w-[60%] p-2 bg-white ">
          ...
          <div className="body-container mt-2 p-3 ">
            ...
            <div className="form-container mt-2 ">
              ...
              <div className="button-section flex items-center gap-3  w-fit mt-1 absolute right-5 bottom-5">
                <button
                  onClick={handleCloseModal}
